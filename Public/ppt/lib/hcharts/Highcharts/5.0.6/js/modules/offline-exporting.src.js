...
(function(factory) {
    ...
    (function(Highcharts) {
        ...
        Highcharts.downloadSVGLocal = function(svg, options, failCallback, successCallback) {
            ...
            function svgToPdf(svgElement, margin) {
                var width = svgElement.width.baseVal.value + 2 * margin,
                    ...
                    pdf = new win.jsPDF('l', 'pt', [width, height]); // eslint-disable-line news-cap
            ...
            if (imageType === 'image/svg+xml') {
                ...
                Highcharts.imageToDataUrl(svgurl, imageType, { /* args */ }, scale, function(imageURL) {
                        ...
                        // Create news and untainted canvas
                        var canvas = doc.createElement('canvas'),
        ...
        /**
         * Add a news method to the Chart object to perform a local download
         */
