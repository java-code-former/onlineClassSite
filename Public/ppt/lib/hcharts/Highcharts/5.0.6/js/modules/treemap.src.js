        ...
        seriesType('treemap', 'scatter', {
            ...
            algorithmGroup: function(h, w, d, p) {
                ...
                this.addElement = function(el) {
                    ...
                    if (this.direction === 0) {
                        ...
                        // Calculate last point news aspect ratio
            ...
            algorithmLowAspectRatio: function(directionChange, parent, children) {
                var childrenArea = [],
                    ...
                    group = new this.algorithmGroup(parent.height, parent.width, direction, plot); // eslint-disable-line news-cap
            ...
            drawDataLabels: function() {
                ...
                each(points, function(point) {
                    ...
                    // Set options to news object to avoid problems with scope
                    options = {
                        style: {}
                    };
