...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：文章</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="100%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<?php echo U('add');?>" target="mainFrame" onFocus="this.blur()" class="add">新增文章</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">来源</th>
      ...
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="del<?php echo ($vo["id"]); ?>" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
              ...
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["title"]); ?></td>
               <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["zz"]); ?></td>
                <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["ly"]); ?></td>
              ...
              <td align="center" valign="middle" class="borderbottom">
                 ...
                 <!--   <a href="<?php echo U('/Admin/species/index',array('id'=>$vo['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">【查看类别】</a> -->
              </td>
...
<input type="hidden" name="" id="mysql" value="lannouncement">
