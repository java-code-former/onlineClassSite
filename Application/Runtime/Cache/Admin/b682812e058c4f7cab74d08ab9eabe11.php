  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="100%" height="50px" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<?php echo U('add');?>"  onFocus="this.blur()" ></a></td>
  		</tr>
	</table>
    </td>
  </tr>
...
<!--           <th align="center" valign="middle" class="borderright">培训类型</th>
          <th align="center" valign="middle" class="borderright">省</th>
           <th align="center" valign="middle" class="borderright">市</th>
            <th align="center" valign="middle" class="borderright">县</th>
        <th align="center" valign="middle" class="borderright">电话</th>
        <th align="center" valign="middle" class="borderright">报名时间</th> -->
...
<!--                <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["tn"]); ?></td>
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["sheng"]); ?></td>
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["shi"]); ?></td>
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["xian"]); ?></td>
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["tel"]); ?></td> -->
<!--               <td align="center" valign="middle" class="borderright borderbottom">
               <?php echo (date('Y-m-d  H:i:s',$vo['create'])); ?>
              </td> -->
              <td align="center" valign="middle" class="borderbottom">
                  <a href="<?php echo U('save',array('id'=>$vo['id'],'t'=>'1'));?>" target="mainFrame" onFocus="this.blur()" class="add">【修改用户名】</a>
                  <span class="gray">&nbsp;|&nbsp;</span>
                                    <a href="<?php echo U('save',array('id'=>$vo['id'],'t'=>'2'));?>" target="mainFrame" onFocus="this.blur()" class="add">【修改密码】</a>
                  <span class="gray">&nbsp;|&nbsp;</span>
...
<input type="hidden" name="" id="mysql" value="user">
<script src="/Public/Home/js/jquery-1.7.2.min.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="/Public/Admin/js/puble.js"></script>