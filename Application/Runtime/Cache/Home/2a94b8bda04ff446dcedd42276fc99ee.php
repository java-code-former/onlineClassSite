        ...
        <div class="IObie">
            ...
            <div class="IOBtwo">
                <?php if(is_array($gg)): $i = 0; $__LIST__ = array_slice($gg,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="IOBWleft left">
                        <div class="IOBWimg"><a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"><img
                                src="/Public/update/<?php echo ($vo["img"]); ?>" width="475"></a></div>
                        <div class="IOBWnei">
                            <dl>
                                <dt><a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"></a></dt>
                                <dd><a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["content"])),0,230,'utf-8')); ?>......</a>
                                </dd>
                            </dl>
                            <div class="IOBWbottom">
                                <a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"><img src="/Public/Home/images/m1.png"
                                                                                     width="18"></a>
                ...
                <div class="IOBWright right">
                        ...
                        <ul>
                            <?php if(is_array($gg)): $i = 0; $__LIST__ = array_slice($gg,1,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="margin:0;">
                                    ...
                                    <div class="right IBWLItext">
                                        <dl>
                                            <dt>
                                                <a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["title"])),0,30,'utf-8')); ?>......</a>
                                            </dt>
                                            <dd><a href="<?php echo U('/New/i',array('id'=>$vo['id']));?>"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["content"])),0,30,'utf-8')); ?>......</a>
                                            </dd>
                                        </dl>
                                    </div>
                                    <div class="clear"></div>
                    ...
                    <div class="IOBWmore"><a href="<?php echo U('/New/index');?>">查看更多</a></div>
                </div>
                <div class="clear"></div>
            </div>
        </div>
    ...
    function ai(data) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var str = '';
                for (var key in data) {str += '<div class="IWNlist" id="k1" style="float:left"><ul><li style="margin-left:0;"><div class="IWimg" ><a href="/Act/i/id/'+data[key]["id"]+'"><img style="width:278px;height: 278px;" src="/Public/update/' + data[key]['img'] + '"" width="279"></a></div><div class="IWten" style="text-align: center" ><dl><dt><a href="/Act/i/id/'+data[key]["id"]+'">' + data[key]['name'] + '</a></dt></dl></div><div class="IWten" style="text-align: center"><dl><dd><a href="/Act/i/id/'+data[key]["id"]+'">' + data[key]['ynum'] + '&nbsp;&nbsp;&nbsp;&nbsp;' + data[key]['snum'] + '</a></dd></dl></div></li><div class="clear"></div></ul></div>';}
                $(".IWrong").html(str);
            }
        });
    }
