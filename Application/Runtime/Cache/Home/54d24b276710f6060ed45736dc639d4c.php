        ...
        <div class="HDSPbig">
            <div class="left HDSPleft">
                <div class="HSPLtitle">
                    ...
                    href="<?php echo U('/Act/index',array('id'=>$_GET['id']));?>" >指导老师</a>
                    <a
                    <?php if($_GET['ppt'] == 2): ?>class="fist"<?php endif; ?>
                    href="<?php echo U('/Act/index',array('id'=>$_GET['id'],'ppt'=>'2'));?>">项目组</a>
                    <a
                    <?php if($_GET['ppt'] == 3): ?>class="fist"<?php endif; ?>
                    href="<?php echo U('/Act/index',array('id'=>$_GET['id'],'ppt'=>'3'));?>">往届学生</a>
                    <div class="clear"></div>
                </div>
                <div class="HSPLcent">
                    <ul>
                        <?php if(is_array($voice)): $i = 0; $__LIST__ = $voice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <div class="HSPLlistO">
                                    <dl>
                                        ...
                                        <dd>
                                            <a href="<?php echo U('/Act/i',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
                                        </dd>
                                    </dl>
                                </div>
                                <div class="HSPLltwo">
                                ...
                                <div class="HDSPRcent">
                                    <?php if(is_array($voicep)): $i = 0; $__LIST__ = array_slice($voicep,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="HSRlist">
                                            <div class="left HSRimg"><a
                                                    href="<?php echo U('/Act/i',array('id'=>$vo['id']));?>"><img
                                                    src="/Public/update/<?php echo ($vo["img"]); ?>" width="163"></a></div>
                                            <div class="right HSRong">
                                                <dl>
                                                    <dt><?php echo ($i); ?></dt>
                                                    <dd><a href="<?php echo U('/Act/i',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
                                                    </dd>
                                                    <dd><a href="<?php echo U('/Act/i',array('id'=>$vo['id']));?>"><?php echo ($vo["ynum"]); ?></a>
                                                    </dd>
                                                    <dd><a href="<?php echo U('/Act/i',array('id'=>$vo['id']));?>"><?php echo ($vo["snum"]); ?></a>
                                                    </dd>
                                                </dl>
                                            </div>
                                            <div class="clear"></div>
