...
<div class="NYbig">
    <div class="width1200">
        <div class="GRBbig">
            <div class="GRBt">优秀课程</div>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="am-panel am-panel-default am-margin-top">
                    <div class="am-panel-hd am-text-bold">最新课程</div>
                    <ul class="am-panel-bd am-avg-md-3">
                        <li>
                            <div>
                                <div class="am-u-sm-4 am-padding-horizontal-0">
                                    <a href="<?php echo U('/enem/the/info',array('id'=>$vo['id']));?>">
                                        <img class="am-img-thumbnail" width="109" height="150"
                                             onerror="this.src='/images/java.png'" src="/Public/update/<?php echo ($vo["img"]); ?>">
                                    </a>
                                </div>
                                <div class="am-u-sm-8">
                                    <a href="<?php echo U('/enem/the/info',array('id'=>$vo['id']));?>"
                                       class="am-text-bold am-text-green"><?php echo ($vo["name"]); ?></a>
                                    <div class="am-padding-top-xs am-text-sm am-text-gray"><?php echo ($vo["title"]); ?></div>
                                </div>
                            </div>
                            <div class="am-clearfix am-padding-top-sm">
                                <a class="am-btn am-btn-jtree am-radius am-text-sm"
                                   href="<?php echo U('/enem/the/info',array('id'=>$vo['id']));?>">马上学习</a>
                            </div>
                        </li>
                    </ul>
