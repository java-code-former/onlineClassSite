        ...
        <div class="NEWbig">
            <ul>
                <?php if(is_array($voice)): $i = 0; $__LIST__ = $voice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="left NEWleft"><a href="<?php echo U('/enem/New/i',array('id'=>$vo['id']));?>"><img
                                src="/Public/update/<?php echo ($vo["img"]); ?>" width="228"></a></div>
                        <div class="right NEWright">
                            <dl>
                                <dt><a href="<?php echo U('/enem/New/i',array('id'=>$vo['id']));?>"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["title"])),0,30,'utf-8')); ?>......</a>
                                </dt>
                                <dd><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["content"])),0,220,'utf-8')); ?>......<a
                                        href="<?php echo U('/enem/New/i',array('id'=>$vo['id']));?>">[详情]</a></dd>
                                <dd class="dd1">发布：<?php echo (date( "m月.d日",$vo["create"])); ?></dd>
                            </dl>
                        </div>
                        <div class="clear"></div>
