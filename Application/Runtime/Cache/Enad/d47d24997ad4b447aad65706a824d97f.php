...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：成员管理</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="100%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<?php echo U('add',array('pid'=>$_GET['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">新增</a></td>
  		</tr>
	</table>
    </td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">名称</th>
         <th align="center" valign="middle" class="borderright">职称</th>
      ...
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="del<?php echo ($vo["id"]); ?>" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
              ...
              <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["name"]); ?></td>
               <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["ynum"]); ?></td>
                <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["snum"]); ?></td>
              ...
              <td align="center" valign="middle" class="borderbottom">
                  ...
                  <span class="gray">&nbsp;|&nbsp;</span>
                   <!-- <a href="<?php echo U('/Admin/category/index',array('id'=>$vo['id']));?>" target="mainFrame" onFocus="this.blur()" class="add">【查看班级成员】</a> -->
              </td>
...
<input type="hidden" name="" id="mysql" value="outstandingprogram">
...
<script>
  //修改是否显示
function is_kai(data)
{
    var mysql=$("#mysql").val();
    var sort=$("#is_kai"+data).text();
    var id=data;
    if(sort=='是'){
        var d=0;
        var c="否"
