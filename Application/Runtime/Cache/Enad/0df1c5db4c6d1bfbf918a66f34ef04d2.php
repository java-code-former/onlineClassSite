    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right" valign="top" id="header-right">
        	<a href="<?php echo U('/Enad/Login/logout');?>" target="topFrame" onFocus="this.blur()" class="admin-out">注销</a>
            <!-- <a href="index.html" target="top" onFocus="this.blur()" class="admin-home">管理首页</a> -->
        	<a href="/enem/index/index" target="_blank" onFocus="this.blur()" class="admin-index">网站首页</a>       	
            <span>
<!-- 日历 -->
